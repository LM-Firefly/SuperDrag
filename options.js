chrome.storage.sync.get({ superDrag: _getDefault() }, function (superDrag) {
  ...
  document.getElementById("common").innerHTML =
    chrome.i18n.getMessage("common");
  document.getElementById("direction").innerHTML =
    chrome.i18n.getMessage("direction");
  document.getElementById("direction_des").innerHTML =
    chrome.i18n.getMessage("direction_des");
  document.getElementById("enableAlt_text").innerHTML =
    chrome.i18n.getMessage("enableAlt_text");
  document.getElementById("timeout_des").innerHTML =
    chrome.i18n.getMessage("timeout_des");
  document.getElementById("timeout_des2").innerHTML =
    chrome.i18n.getMessage("timeout_des2");
  document.getElementById("firstEventDesc").innerHTML =
    chrome.i18n.getMessage("firstEventDesc");
  document.getElementById("saveAsDesc").innerHTML =
    chrome.i18n.getMessage("saveAsDesc");
  document.getElementById("showNoticeDesc").innerHTML =
    chrome.i18n.getMessage("showNoticeDesc");
  document.getElementById("openLinksDesc").innerHTML =
    chrome.i18n.getMessage("openLinksDesc");
  document.getElementById("openLinksDesc2").innerHTML =
    chrome.i18n.getMessage("openLinksDesc2");
  document.getElementById("openLinksDesc3").innerHTML =
    chrome.i18n.getMessage("openLinksDesc3");
  document.getElementById("openLinksPrompt").innerHTML =
    chrome.i18n.getMessage("openLinksPrompt");
  document.getElementById("effect_text_prompt").innerHTML =
    chrome.i18n.getMessage("effectPrompt");
  document.getElementById("effect_link_prompt").innerHTML =
    chrome.i18n.getMessage("effectPrompt");
  document.getElementById("effect_img_prompt").innerHTML =
    chrome.i18n.getMessage("effectPrompt");
  document.getElementById("fieldtext0").innerHTML =
    chrome.i18n.getMessage("fieldtext0");
  document.getElementById("fieldlink0").innerHTML =
    chrome.i18n.getMessage("fieldlink0");
  document.getElementById("fieldimg0").innerHTML =
    chrome.i18n.getMessage("fieldimg0");
  document.getElementById("searchUrlDescription").innerHTML =
    chrome.i18n.getMessage("searchUrlDescription");
  document.getElementById("linkSearchUrlDescription").innerHTML =
    chrome.i18n.getMessage("searchUrlDescription");
  document.getElementById("imgSearchUrlDescription").innerHTML =
    chrome.i18n.getMessage("searchUrlDescription");
  document.getElementById("enableAlt").checked = superDrag.superDrag.enableAlt;
  document.getElementById("firstEvent").checked =
    superDrag.superDrag.firstEvent;
  document.getElementById("saveAs").checked = superDrag.superDrag.saveAs;
  document.getElementById("showNotice").checked =
    superDrag.superDrag.showNotice;
  ...
  function _load_effect_text(_id, superDrag) {
    if (_id === 1) {
      ...
      document.getElementById("text_up").innerHTML =
        arrow[superDrag.superDrag.direction_sel][0];
      document.getElementById("text_down").innerHTML =
        arrow[superDrag.superDrag.direction_sel][1];
      document.getElementById("text_left").innerHTML =
        arrow[superDrag.superDrag.direction_sel][2];
      document.getElementById("text_right").innerHTML =
        arrow[superDrag.superDrag.direction_sel][3];
    }
  }
  ...
  function _load_effect_link(_id, superDrag) {
    if (_id === 1) {
      ...
      document.getElementById("link_up").innerHTML =
        arrow[superDrag.superDrag.direction_sel][0];
      document.getElementById("link_down").innerHTML =
        arrow[superDrag.superDrag.direction_sel][1];
      document.getElementById("link_left").innerHTML =
        arrow[superDrag.superDrag.direction_sel][2];
      document.getElementById("link_right").innerHTML =
        arrow[superDrag.superDrag.direction_sel][3];
    }
  }
  ...
  function _load_effect_img(_id, superDrag) {
    if (_id === 1) {
      ...
      document.getElementById("img_up").innerHTML =
        arrow[superDrag.superDrag.direction_sel][0];
      document.getElementById("img_down").innerHTML =
        arrow[superDrag.superDrag.direction_sel][1];
      document.getElementById("img_left").innerHTML =
        arrow[superDrag.superDrag.direction_sel][2];
      document.getElementById("img_right").innerHTML =
        arrow[superDrag.superDrag.direction_sel][3];
    }
  }
  ...
  function _load_search_engine() {
    for (let i = 0; i < 4; i++) {
      ...
      if (isNaN(engines[i])) {
        // user search engines
        document.getElementById("search_engine_url_" + i).value =
          engines[i].url;
        ...
        // build-in
        document.getElementById("search_engine_url_" + i).value =
          _build_in_seach_engines[engines[i]].url;
  ...
  function _load_link_search_engine() {
    for (let i = 0; i < 4; i++) {
      ...
      if (isNaN(engines[i])) {
        // user search engines
        document.getElementById("link_search_engine_url_" + i).value =
          engines[i].url;
        _s.selectedIndex = _build_in_seach_engines.length;
  ...
  function _load_img_search_engine() {
    for (let i = 0; i < 4; i++) {
      ...
      if (isNaN(engines[i])) {
        // user search engines
        document.getElementById("img_search_engine_url_" + i).value =
          engines[i].url;
        ...
        // build-in
        document.getElementById("img_search_engine_url_" + i).value =
          _build_in_seach_engines_for_img[engines[i]].url;
        _s.selectedIndex = engines[i];
  ...
  function _init_selects(_id) {
    ...
    if (!_select.options.length) {
      ...
      _select.add(
        new Option(chrome.i18n.getMessage("custom_search"), -1, false, false)
      );
    }
    return _select;
  }
  ...
  function _init_img_selects(_id) {
    ...
    if (!_select.options.length) {
      for (let i = 0; i < _build_in_seach_engines_for_img.length; i++) {
        _select.add(
          new Option(_build_in_seach_engines_for_img[i].name, i, false)
        );
      }
      _select.add(
        new Option(chrome.i18n.getMessage("custom_search"), -1, false, false)
  ...
  function _save_direction_sel(_select, superDrag) {
    // select
  ...
  function _save_effect_text(_select, superDrag) {
    // select
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_effect_link(_select, superDrag) {
    // select
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_effect_img(_select, superDrag) {
    // select
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_open_type(_select, superDrag) {
    // select
  ...
  function _save_open_type_link(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_open_type_img(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_open_type_open_links(_select, superDrag) {
    // select
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_text_type(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
    if (Number(_v) === 0) {
      ...
      document.getElementById("search_engine_url_" + _id).value =
        _build_in_seach_engines[_v].url;
  ...
  function _save_link_type(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
    if (Number(_v) === 0) {
      ...
      document.getElementById(
        "link_search_engine_select_" + _id
      ).style.display = "none";
  ...
  function _save_img_type(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
  ...
  function _save_search_engine(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
    if (Number(_v) === -1) {
      // add new
      if (isNaN(superDrag.superDrag.searchEngines[_id]))
        // still from select
        document.getElementById("search_engine_url_" + _id).value =
          superDrag.superDrag.searchEngines[_id].url;
      else document.getElementById("search_engine_url_" + _id).value = "";
      document.getElementById("search_engine_url_" + _id).readOnly = false;
    } else {
      // select from build-in
      document.getElementById("search_engine_url_" + _id).value =
        _build_in_seach_engines[_v].url;
      document.getElementById("search_engine_url_" + _id).readOnly = true;
  ...
  function _save_link_search_engine(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
    if (Number(_v) === -1) {
      // add new
      if (isNaN(superDrag.superDrag.linkSearchEngines[_id]))
        // still from select
        document.getElementById("link_search_engine_url_" + _id).value =
          superDrag.superDrag.linkSearchEngines[_id].url;
      else document.getElementById("link_search_engine_url_" + _id).value = "";
  ...
  function _save_img_search_engine(_select, superDrag) {
    // select
    const _id = _select.getAttribute("myAttr");
    const _v = _select.options[_select.selectedIndex].value;
    if (Number(_v) === -1) {
      // add new
      if (isNaN(superDrag.superDrag.imgSearchEngines[_id]))
        // still from select
        document.getElementById("img_search_engine_url_" + _id).value =
          superDrag.superDrag.imgSearchEngines[_id].url;
      else document.getElementById("img_search_engine_url_" + _id).value = "";
      document.getElementById("img_search_engine_url_" + _id).readOnly = false;
    } else {
      // select from build-in
      document.getElementById("img_search_engine_url_" + _id).value =
        _build_in_seach_engines_for_img[_v].url;
  ...
  function _add_search_engine(_id, superDrag) {
    // add new
    const url = document.getElementById(
      "search_engine_url_" + _id.getAttribute("myAttr")
    ).value;
  ...
  function _add_link_search_engine(_id, superDrag) {
    // add new
    const url = document.getElementById(
      "link_search_engine_url_" + _id.getAttribute("myAttr")
    ).value;
  ...
  function _add_img_search_engine(_id, superDrag) {
    // add new
    const url = document.getElementById(
      "img_search_engine_url_" + _id.getAttribute("myAttr")
    ).value;
